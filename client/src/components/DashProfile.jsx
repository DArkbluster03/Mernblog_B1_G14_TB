...
const handleSubmit = async (e) => {
  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
      <h1 className='my-7 ntext-center font-semibold text-3xl'>Profile</h1>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        <input type="file" accept='image/*' onChange={handleImageChange}
        ref={filePickerRef}
        hidden
        /> 
        <div className='relative w-12 h-32 self-center cursor-pointer shadow-md overflow-hidden rounded-full'
