...
import { MdModeEdit } from 'react-icons/md'; // Assuming you're using react-icons for the edit icon
...
const ManagePosts = () => {
  ...
  const handleDelete = async (id) => {
    try {
      ...
      refetch(); // Corrected refetch typo
    } catch (error) {
                ...
                <table className="items-center bg-transparent w-full border-collapse">
                  <thead>
                    <tr>
                      ...
                      <th className="px-6 bg-blueGray-50 text-blueGray-500 align-middle border border-solid border-blueGray-100 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">Blog Name</th>
                      <th className="px-6 bg-blueGray-50 text-blueGray-500 align-middle border border-solid border-blueGray-100 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">Publishing Date</th>
                  ...
                  <tbody>
                    {blogs && blogs.map((blog, index) => (
                      <tr key={blog._id}>
                        ...
                        <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">{blog.title}</td>
